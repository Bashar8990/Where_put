...
export function PrivacyPage() {
  return (
    <AppLayout>
      ...
      <div className="bg-surface border border-app rounded-2xl p-5 space-y-4 text-sm leading-relaxed text-app">
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 rounded-xl p-3 text-amber-800 dark:text-amber-300">
